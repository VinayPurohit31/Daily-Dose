        ...
        <View style={styles.container}>
            ...
            <View style={styles.card}>
                ...
                {[
                    ...
                    { label: 'Dose', value: `${medicine?.dose} ${medicine?.type?.name}` }
                ].map((item, index) => (
...
const styles = StyleSheet.create({
    ...
    card: { backgroundColor: Colors.WHITE, borderRadius: 20, padding: 25, marginBottom: 20, shadowOpacity: 0.2, shadowRadius: 10, elevation: 6 },
    ...
    pickerContainer: { width: '100%', backgroundColor: Colors.WHITE, borderRadius: 12, marginBottom: 20, borderWidth: 1, borderColor: Colors.LIGHT_GRAY_BORDER, paddingHorizontal: 15 },
